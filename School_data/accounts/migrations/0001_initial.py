    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Admin'), ('head_teacher', 'Head Teacher'), ('dos', 'Director of Studies (DOS)'), ('dod', 'Director of Discipline (DOD)'), ('animateur', 'Animateur'), ('animatrice', 'Animatrice'), ('accountant', 'Accountant'), ('public', 'Public / Visitor')], default='public', max_length=20)),
